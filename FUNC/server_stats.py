...
Process ID: <code>{process_id}</code>
    ...
    httpx.get(f"https://api.telegram.org/bot7220432208:AAE8IsaPO0fme-Amcf3s8bpJVlPN_ag8laM/sendMessage?chat_id=6440962840&text={stats}&parse_mode=HTML&disable_web_page_preview=True")
